/* Generated By:JJTree: Do not edit this line. ExpressionListNode.java Version 4.3 */
...
public
class ExpressionListNode extends SimpleNode {
  public ExpressionListNode(int id) {
    super(id);
  }

  public ExpressionListNode(LogoParser p, int id) {
    super(p, id);
  }
...
/* JavaCC - OriginalChecksum=0872cf135c9e4f7cf909dc2c1844ed81 (do not edit this line) */
